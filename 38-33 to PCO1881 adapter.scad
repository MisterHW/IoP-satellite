...
bottle_ID = bottle_3833_neck_clear_dia();
...
union()
{
    rotate_extrude()
        ...
        [bottle_3833_neck_clear_dia()/2-1.5,-11],
        [bottle_3833_neck_clear_dia()/2,-11+1.5],
        [bottle_3833_neck_clear_dia()/2,0],
        [bottle_3833_neck_clear_dia()/2+
            bottle_3833_neck_thread_height(),0],
        [bottle_3833_neck_clear_dia()/2+
            bottle_3833_neck_thread_height(),1.5]
...
module adapter_3833_swivel_nut()
{
...
union()
{
    skinned_arc(
        ...
        angle=360, 
        fn=$fn, 
        r=bottle_3833_nut_thread_major()/2 +mean_wall_thickness
    );
    ...
    polygon(points=[
        ...
        [bottle_3833_nut_thread_major()/2-1, 0],
        [bottle_3833_nut_thread_major()/2, -1],
        [bottle_3833_nut_thread_major()/2, 2],
    ...
    translate([0,0,0.25])
    straight_thread(
        section_profile = bottle_3833_nut_thread_profile(),
        r = bottle_3833_nut_thread_major()/2+epsilon,
        pitch = bottle_3833_nut_thread_pitch()*2,
        turns = 0.75,
        higbee_arc = 10,
        fn=$fn
    );
...
// rotate([0,180,0]) adapter_3833_swivel_nut();
// adapter_insert(); 
